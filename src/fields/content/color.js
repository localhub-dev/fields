...
export default class Color extends Field {
  /**
   * Color fields provide a color picker interface for content creators. They support solid
   * colors as well as transparency. They are a perfect choice for when you want to give
   * content creators full control over colors within a module. Color fields are supported
   ...
   * @param {string} [data.label='Color field'] The text the content creator sees describing the
   ...
   * @param {string} [data.name='color_field'] The variable name you will use to refer to this
  ...
  constructor (data = {}) {
    super(data);
    this.label = data.label || 'Color field';
     ...
     */
    this.name = data.name || Util.toSnakeCase(this.label) || 'color_field';
  }
}
