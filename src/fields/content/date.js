...
export default class Date extends Field {
  /**
   * Date fields provide a date picker interface to make it easy for content creators to
   * select a date. Returns a timestamp you can use in your code. Date fields are supported
   * in modules.
   ...
   * @param {string} [data.label='Event start date'] The text the content creator sees describing the
   ...
   * @param {string} [data.name='event_start_date'] The variable name you will use to refer to this
  ...
  constructor (data = {}) {
    super(data);
    this.label = data.label || 'Event start date';
     ...
     */
    this.name = data.name || Util.toSnakeCase(this.label) || 'event_start_date';
  }
}
