...
export default class RichText extends Field {
   ...
   * @param {Array} [data.enabled_features] An array of items that allows you to configure
   * the Rich Text Editor Toolbar and what options are available for content editors. 
   ...
   * @param {string} [data.label='Description'] The text the content creator sees describing the
   ...
   * @param {string} [data.name='description'] The variable name you will use to refer to this
