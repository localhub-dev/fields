...
export default class DateTime extends Field {
  /**
   * Date and time fields provide a date picker interface just like the date field, as
   * well as a time picker to make it easy for content creators to select a date and time
   * of day. Returns a timestamp you can use in your code. Date and time fields are
   ...
   * @param {string} [data.label='Event start'] The text the content creator sees describing the
   ...
   * @param {string} [data.name='event_start'] The variable name you will use to refer to this
  ...
  constructor (data = {}) {
    super(data);
    this.label = data.label || 'Event start';
     ...
     */
    this.name = data.name || Util.toSnakeCase(this.label) || 'event_start';
  }
}
